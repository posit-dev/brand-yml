...
<code><span class="parameter-name">which</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[ToHtmlArgWhichType](`brand_yml.logo.ToHtmlArgWhichType`)</span></code>
...
<code><span class="parameter-name">method</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[ToHtmlArgMethodType](`brand_yml.logo.ToHtmlArgMethodType`)</span> <span class="parameter-default-sep">=</span> <span class="parameter-default">'inline'</span></code>
...
<code><span class="parameter-name">selectors</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[ToHtmlArgSelectorsType](`brand_yml.logo.ToHtmlArgSelectorsType`)</span> <span class="parameter-default-sep">=</span> <span class="parameter-default">{'light': ['[data-bs-theme="light"]', '.quarto-light'], 'dark': ['[data-bs-theme="dark"]', '.quarto-dark']}</span></code>
...
<code><span class="parameter-name">selectors</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[ToHtmlArgSelectorsType](`brand_yml.logo.ToHtmlArgSelectorsType`)</span> <span class="parameter-default-sep">=</span> <span class="parameter-default">None</span></code>
