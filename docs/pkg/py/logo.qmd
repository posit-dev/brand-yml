...
| [attrs](#brand_yml.logo.BrandLogoResource.attrs) | Additional attributes for HTML/markdown rendering. |
...
| Name | Description |
| --- | --- |
| [tagify](#brand_yml.BrandLogoResource.tagify) | Convenience method for `.to_html()`, for use in Shiny apps. |
| [to_html](#brand_yml.BrandLogoResource.to_html) | Generate HTML img tag for the logo resource. |
| [to_markdown](#brand_yml.BrandLogoResource.to_markdown) | Generate markdown image syntax for the logo resource. |
| [to_str](#brand_yml.BrandLogoResource.to_str) | Convert logo resource to string representation. |

### tagify { #brand_yml.BrandLogoResource.tagify }
...
|--------|----------------------------------|---------------------------|
|        | [Tagified](`htmltools.Tagified`) | HTML img tag as a string. |
...
<code><span class="parameter-name">**kwargs</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Any](`typing.Any`)</span> <span class="parameter-default-sep">=</span> <span class="parameter-default">{}</span></code>
...
| Name   | Type                                            | Description               |
|--------|-------------------------------------------------|---------------------------|
|        | [htmltools](`htmltools`).[Tag](`htmltools.Tag`) | HTML img tag as a string. |

### to_markdown { #brand_yml.BrandLogoResource.to_markdown }
...
| Name   | Type         | Description                        |
|--------|--------------|------------------------------------|
|        | [str](`str`) | Markdown image syntax as a string. |

### to_str { #brand_yml.BrandLogoResource.to_str }
...
<code><span class="parameter-name">format_type</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[str](`str`)</span> <span class="parameter-default-sep">=</span> <span class="parameter-default">'html'</span></code>
...
| Name   | Type         | Description                                    |
|--------|--------------|------------------------------------------------|
|        | [str](`str`) | String representation in the specified format. |
