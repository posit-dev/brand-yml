...
| Name | Description |
| --- | --- |
| [css_variables](#brand_yml.Brand.css_variables) | Generate mode-aware CSS custom properties for this brand. |
...
### css_variables { #brand_yml.Brand.css_variables }

```python
Brand.css_variables(mode_scopes=None)
```
...
<code><span class="parameter-name">mode_scopes</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[Mapping](`collections.abc.Mapping`)\[[Literal](`typing.Literal`)\[\'light\', \'dark\'\], [str](`str`)\] \| None</span> <span class="parameter-default-sep">=</span> <span class="parameter-default">None</span></code>
...
|--------|--------------|--------------------------------------------------------------------------------------------------------------------------------------|
|        | [str](`str`) | CSS rules containing defined brand custom properties for both color modes. A value undefined in one mode is omitted from that scope. |
