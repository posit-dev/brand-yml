...
| [from_yaml_str](#brand_yaml.Brand.from_yaml_str) | Create a Brand instance from a string of YAML. |
| [model_dump_yaml](#brand_yaml.Brand.model_dump_yaml) | Serialize the Brand object to YAML. |
