...
```python
Brand.from_yaml(path, default_font_source=None)
```
...
<code><span class="parameter-name">default_font_source</span><span class="parameter-annotation-sep">:</span> <span class="parameter-annotation">[FontSourceDefaultsType](`brand_yml.typography.FontSourceDefaultsType`) \| None</span> <span class="parameter-default-sep">=</span> <span class="parameter-default">None</span></code>
