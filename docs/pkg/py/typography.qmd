...
| Name | Description |
| --- | --- |
| [model_dump](#brand_yml.typography.BrandTypographyGoogleFontsWeightRange.model_dump) | !!! abstract "Usage Documentation"     [`model_dump`](../concepts/serialization.md#python-mode) |
