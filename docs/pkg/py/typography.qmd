...
# typography { #brand_yaml.typography }
...
| Name | Description |
| --- | --- |
| [BrandTypographyFontFamily](#brand_yaml.typography.BrandTypographyFontFamily) | Runtime representation of an annotated type. |

## Classes

| Name | Description |
| --- | --- |
| [BrandTypographyFontSource](#brand_yaml.typography.BrandTypographyFontSource) | A base class representing a font source. |
| [BrandTypographyFontFiles](#brand_yaml.typography.BrandTypographyFontFiles) | A font family defined by a collection of font files. |
| [BrandTypographyFontGoogle](#brand_yaml.typography.BrandTypographyFontGoogle) | A font family provided by Google Fonts. |
| [BrandTypographyFontBunny](#brand_yaml.typography.BrandTypographyFontBunny) | A font family provided by Bunny Fonts. |
| [BrandTypographyGoogleFontsApi](#brand_yaml.typography.BrandTypographyGoogleFontsApi) | A font source that utilizes the Google Fonts (or a compatible) API. |
| [BrandTypographyGoogleFontsWeightRange](#brand_yaml.typography.BrandTypographyGoogleFontsWeightRange) | Represents a range of font weights for Google Fonts. |
| [BrandTypographyBase](#brand_yaml.typography.BrandTypographyBase) | Typographic settings for base (or body) text. |
| [BrandTypographyHeadings](#brand_yaml.typography.BrandTypographyHeadings) | Typographic settings for headings and titles. |
| [BrandTypographyMonospace](#brand_yaml.typography.BrandTypographyMonospace) | Typographic settings for monospace text. |
| [BrandTypographyMonospaceInline](#brand_yaml.typography.BrandTypographyMonospaceInline) | Typographic settings for inline monospace text. |
| [BrandTypographyMonospaceBlock](#brand_yaml.typography.BrandTypographyMonospaceBlock) | Typographic settings for block monospace text. |
| [BrandTypographyLink](#brand_yaml.typography.BrandTypographyLink) | Typographic settings for hyperlinks. |

### BrandTypographyFontSource { #brand_yaml.typography.BrandTypographyFontSource }
...
| Name | Description |
| --- | --- |
| [family](#brand_yaml.typography.BrandTypographyFontSource.family) | The font family name. |
| [source](#brand_yaml.typography.BrandTypographyFontSource.source) | The source of the font family, one of `"system"`, `"file"`, `"google"`, or `"bunny"`. |

#### Methods

| Name | Description |
| --- | --- |
| [to_css](#brand_yaml.typography.BrandTypographyFontSource.to_css) | Create the CSS declarations needed to use the font family. |

##### to_css { #brand_yaml.typography.BrandTypographyFontSource.to_css }

`typography.BrandTypographyFontSource.to_css()`

Create the CSS declarations needed to use the font family.

### BrandTypographyFontFiles { #brand_yaml.typography.BrandTypographyFontFiles }
...
### BrandTypographyFontGoogle { #brand_yaml.typography.BrandTypographyFontGoogle }
...
### BrandTypographyFontBunny { #brand_yaml.typography.BrandTypographyFontBunny }
...
### BrandTypographyGoogleFontsApi { #brand_yaml.typography.BrandTypographyGoogleFontsApi }
...
| Name | Description |
| --- | --- |
| [display](#brand_yaml.typography.BrandTypographyGoogleFontsApi.display) | Specifies how a font face is displayed based on whether and when it is downloaded and ready to use. |
| [style](#brand_yaml.typography.BrandTypographyGoogleFontsApi.style) | The font style(s) (italic or normal) to be imported for the font family. |
| [url](#brand_yaml.typography.BrandTypographyGoogleFontsApi.url) | URL of the Google Fonts-compatible API. (Primarily for internal use.) |
| [version](#brand_yaml.typography.BrandTypographyGoogleFontsApi.version) | Google Fonts API version. (Primarily for internal use.) |
| [weight](#brand_yaml.typography.BrandTypographyGoogleFontsApi.weight) | The desired front weights to be imported for the font family. |

#### Methods

| Name | Description |
| --- | --- |
| [to_import_url](#brand_yaml.typography.BrandTypographyGoogleFontsApi.to_import_url) | Returns the URL for the font family to be used in a CSS `@import` statement. |

##### to_import_url { #brand_yaml.typography.BrandTypographyGoogleFontsApi.to_import_url }
...
### BrandTypographyGoogleFontsWeightRange { #brand_yaml.typography.BrandTypographyGoogleFontsWeightRange }
...
:   [list](`list`)\[[BrandTypographyFontWeightInt](`brand_yaml.typography.BrandTypographyFontWeightInt`)\]
...
| Name | Description |
| --- | --- |
| [model_dump](#brand_yaml.typography.BrandTypographyGoogleFontsWeightRange.model_dump) | Usage docs: https://docs.pydantic.dev/2.9/concepts/serialization/#modelmodel_dump |

##### model_dump { #brand_yaml.typography.BrandTypographyGoogleFontsWeightRange.model_dump }

`typography.BrandTypographyGoogleFontsWeightRange.model_dump(mode='python', include=None, exclude=None, context=None, by_alias=False, exclude_unset=False, exclude_defaults=False, exclude_none=False, round_trip=False, warnings=True, serialize_as_any=False)`
...
### BrandTypographyBase { #brand_yaml.typography.BrandTypographyBase }
...
### BrandTypographyMonospace { #brand_yaml.typography.BrandTypographyMonospace }
...
### BrandTypographyMonospaceInline { #brand_yaml.typography.BrandTypographyMonospaceInline }
...
### BrandTypographyMonospaceBlock { #brand_yaml.typography.BrandTypographyMonospaceBlock }
...
### BrandTypographyLink { #brand_yaml.typography.BrandTypographyLink }
