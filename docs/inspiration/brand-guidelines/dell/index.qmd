...
brand_path = "_brand/_brand-dell.yml"

# Validate brand.yml file with Python brand_yml
Brand.from_yaml(brand_path)

# But load YAML directly to keep unvalidated yaml block
