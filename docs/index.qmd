...
<!-- TODO: Links to Quarto and Shiny for Python brand support docs -->

## brand.yml support

**brand.yml** is currently [supported]{.implemented} in [Quarto](https://quarto.org/) websites, presentations and Typst documents, as well as via the [`brand_yml` Python package](pkg/py/).
Support for themed branding is [in progress]{.in-progress} for [Shiny for Python](https://shiny.posit.co/py/).
...
flowchart LR
    ...
    class quarto-websites,quarto-presentations,quarto-typst,py-brand_yml implemented;
...
Katrina Keener and Sofia Torres are data scientists at **Genewise Therapeutics**, a biotech company that uses AI to create tailored treatment plans based on personal genetic makeup and biomarkers.
