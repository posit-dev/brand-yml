...
**brand.yml** is currently [supported]{.implemented} in [Quarto](https://quarto.org/) websites, presentations, dashboards, and Typst documents, as well as via the [`brand_yml` Python package](pkg/py/).
